...
export function AddToSiteProductModalContent({ id }: { id: string }) {
  ...
  const code = `
      <script scr="${env.NEXT_PUBLIC_SERVER_URL}/api/products/${id}/banner"></script>`;
  ...
  return (
    <DialogContent className="max-w-max">
      ...
      <pre className="mb-4 overflow-x-auto p-4 bg-secondary rounded max-w-screen text-secondary-foreground">
        <code>{code}</code>
      </pre>
